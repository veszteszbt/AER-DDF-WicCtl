...
namespace ddf
{
	...
	namespace pirate
	{
			...
			{
				static wicp::role_type device_role("DDF - pirate - cashier_laser_controller");
			...
			{
				static wicp::role_type device_role("DDF - pirate - entrance_hanger_controller");
			...
			{
				static wicp::role_type device_role("DDF - pirate - ghostbox_picture_laser_boat_wheel_controller");
			...
			{
				static wicp::role_type device_role("DDF - pirate - map_controller");
			...
			{
				static wicp::role_type device_role("DDF - pirate - rex_flipper_controller");
			...
			{
				static wicp::role_type device_role("DDF - pirate - stone_chest_controller");
	...
	namespace magician
	{
			...
			{
				static wicp::role_type device_role("DDF - magician - cupboard_controller");
			...
			{
				static wicp::role_type device_role("DDF - magician - design_board_controller");
			...
			{
				static wicp::role_type device_role("DDF - magician - entrance_controller");
			...
			{
				static wicp::role_type device_role("DDF - magician - futuristic_safe_controller");
	...
	namespace villa
	{
			...
			{
				static wicp::role_type device_role("DDF - villa - control_room_controller");
			...
			{
				static wicp::role_type device_role("DDF - villa - desk_controller");
			...
			{
				static wicp::role_type device_role("DDF - villa - desktop_pc");
			...
			namespace entrance_controller
			{
				static wicp::role_type device_role("DDF - villa - entrance_controller");
			...
			{
				static wicp::role_type device_role("DDF - villa - safe_controller");
			...
			{
				static wicp::role_type device_role("DDF - villa - video_device");
	...
	namespace junkyard
	{
			...
			{
				static wicp::role_type device_role("DDF - junkyard - email_client");
			...
			namespace entrance_controller
			{
				static wicp::role_type device_role("DDF - junkyard - entrance_controller");
			...
			{
				static wicp::role_type device_role("DDF - junkyard - secret_box_controller_1");
			...
			{
				static wicp::role_type device_role("DDF - junkyard - secret_box_controller_2");
	...
	namespace service
	{
			...
			namespace comdev
			{
				static wicp::role_type device_role("DDF - service - ComDev");
			...
			namespace gmclient
			{
				static wicp::role_type device_role("DDF - service - GMClient");
