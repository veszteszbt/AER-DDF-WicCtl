...
PI__ const s_productionInfo[] = 
{
     ...
     {327, 2}, // 1: start (CASE_DELIMITER) ->  command_list CASE_DELIMITER
     {328, 3}, // 2: command_list (COMMAND_SEPARATOR) ->  command_list command COMMAND_SEPARATOR
     {328, 3}, // 3: command_list (errTok__) ->  command_list errTok__ COMMAND_SEPARATOR
     {328, 2}, // 4: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR
     {328, 2}, // 5: command_list (errTok__) ->  errTok__ COMMAND_SEPARATOR
     {329, 4}, // 6: command (IDENTIFIER) ->  IDENTIFIER OPEN_PARENTHESIS arguments CLOSING_PARENTHESIS
     {329, 3}, // 7: command (IDENTIFIER) ->  IDENTIFIER OPERATOR_ASSIGN expression
     {329, 4}, // 8: command (KEYWORD_LOCAL) ->  KEYWORD_LOCAL IDENTIFIER OPERATOR_ASSIGN expression
     {329, 3}, // 9: command (OPEN_CURLY_BRACKET) ->  OPEN_CURLY_BRACKET command_list CLOSING_CURLY_BRACKET
     {329, 7}, // 10: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_IN expression_list KEYWORD_DO command_list KEYWORD_DONE
     {329, 9}, // 11: command (KEYWORD_FOR) ->  KEYWORD_FOR command COMMAND_SEPARATOR expression COMMAND_SEPARATOR command KEYWORD_DO command_list KEYWORD_DONE
     {329, 5}, // 12: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {329, 5}, // 13: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {329, 9}, // 14: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_DO caseparts KEYWORD_DEFAULT CLOSING_PARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {329, 6}, // 15: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {330, 3}, // 16: expression (OPEN_PARENTHESIS) ->  OPEN_PARENTHESIS expression CLOSING_PARENTHESIS
     {330, 2}, // 17: expression (NEGATE) ->  NEGATE expression
     {330, 3}, // 18: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {330, 3}, // 19: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {330, 3}, // 20: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {330, 3}, // 21: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {330, 3}, // 22: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {330, 3}, // 23: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {330, 3}, // 24: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {330, 3}, // 25: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {330, 3}, // 26: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {330, 3}, // 27: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {330, 3}, // 28: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {330, 3}, // 29: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {330, 3}, // 30: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {330, 3}, // 31: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {330, 2}, // 32: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {330, 4}, // 33: expression (IDENTIFIER) ->  IDENTIFIER OPEN_SQUARE_BRACKET expression CLOSING_SQUARE_BRACKET
     {330, 1}, // 34: expression (INTEGER) ->  INTEGER
     {330, 1}, // 35: expression (DOUBLE) ->  DOUBLE
     {330, 1}, // 36: expression (SINGLE_QUOTE) ->  SINGLE_QUOTE
     {330, 1}, // 37: expression (DOUBLE_QUOTE) ->  DOUBLE_QUOTE
     {330, 1}, // 38: expression (HEXADECIMAL) ->  HEXADECIMAL
     {330, 1}, // 39: expression ->  input_output
     {330, 1}, // 40: expression (IDENTIFIER) ->  IDENTIFIER
     {330, 3}, // 41: expression (OPEN_SQUARE_BRACKET) ->  OPEN_SQUARE_BRACKET arraypart CLOSING_SQUARE_BRACKET
     {330, 1}, // 42: expression (CONST_NULL) ->  CONST_NULL
     {330, 4}, // 43: expression (COMMAND_RETURNER) ->  COMMAND_RETURNER OPEN_CURLY_BRACKET command CLOSING_CURLY_BRACKET
     {331, 3}, // 44: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression
     {331, 5}, // 45: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression ARROW expression
     {331, 1}, // 46: arraypart ->  expression
     {331, 3}, // 47: arraypart (ARROW) ->  expression ARROW expression
     {331, 0}, // 48: arraypart ->  <empty>
     {332, 3}, // 49: arguments (ELEMENT_SEPARATOR) ->  arguments ELEMENT_SEPARATOR expression
     {332, 1}, // 50: arguments ->  expression
     {332, 0}, // 51: arguments ->  <empty>
     {333, 2}, // 52: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {333, 2}, // 53: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {333, 2}, // 54: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {333, 2}, // 55: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {334, 2}, // 56: caseparts ->  caseparts case_part
     {334, 1}, // 57: caseparts ->  case_part
     {335, 4}, // 58: case_part (CLOSING_PARENTHESIS) ->  expression CLOSING_PARENTHESIS command_list CASE_DELIMITER
     {336, 2}, // 59: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {336, 0}, // 60: else_part ->  <empty>
     {337, 3}, // 61: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {337, 1}, // 62: expression_list ->  expression
     {338, 1}, // 63: start_$ ->  start
};
...
SR__ s_24[] =
{
    ...
    { {       301}, { 55} }, // OPERATOR_AND           
    { {       302}, { 56} }, // OPERATOR_OR            
    { {       303}, { 57} }, // OPERATOR_EQUAL         
    { {       308}, { 58} }, // OPERATOR_NOT_EQUAL     
    { {       307}, { 59} }, // OPERATOR_LESS_EQUAL    
    { {       306}, { 60} }, // OPERATOR_GREATER_EQUAL 
    { {       305}, { 61} }, // OPERATOR_LESS_THAN     
    { {       304}, { 62} }, // OPERATOR_GREATER_THAN  
    { {       309}, { 63} }, // OPERATOR_PLUS          
    { {       310}, { 64} }, // OPERATOR_MINUS         
    { {       311}, { 65} }, // OPERATOR_MULTIPLICATION
    { {       312}, { 66} }, // OPERATOR_DIVISION      
    { {       313}, { 67} }, // OPERATOR_MODULO        
    { {       314}, { 68} }, // OPERATOR_POWER         
    { {         0}, {  0} },                           
};
