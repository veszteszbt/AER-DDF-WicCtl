...
PI__ const s_productionInfo[] = 
{
     ...
     {331, 4}, // 4: command (IDENTIFIER) ->  IDENTIFIER OPEN_PARENTHESIS arguments CLOSING_PARENTHESIS
     {331, 3}, // 5: command (IDENTIFIER) ->  IDENTIFIER OPERATOR_ASSIGN expression
     {331, 4}, // 6: command (KEYWORD_LOCAL) ->  KEYWORD_LOCAL IDENTIFIER OPERATOR_ASSIGN expression
     {331, 3}, // 7: command (OPEN_CURLY_BRACKET) ->  OPEN_CURLY_BRACKET command_list CLOSING_CURLY_BRACKET
     ...
     {331, 9}, // 12: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_DO caseparts KEYWORD_DEFAULT CLOSING_PARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {331, 6}, // 13: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {332, 3}, // 14: expression (OPEN_PARENTHESIS) ->  OPEN_PARENTHESIS expression CLOSING_PARENTHESIS
     ...
     {332, 4}, // 31: expression (IDENTIFIER) ->  IDENTIFIER OPEN_SQUARE_BRACKET expression CLOSING_SQUARE_BRACKET
     {332, 1}, // 32: expression (INTEGER) ->  INTEGER
     {332, 1}, // 33: expression (DOUBLE) ->  DOUBLE
     {332, 1}, // 34: expression (SINGLE_QUOTE) ->  SINGLE_QUOTE
     {332, 1}, // 35: expression (DOUBLE_QUOTE) ->  DOUBLE_QUOTE
     {332, 1}, // 36: expression (HEXADECIMAL) ->  HEXADECIMAL
     {332, 1}, // 37: expression ->  input_output
     {332, 1}, // 38: expression (IDENTIFIER) ->  IDENTIFIER
     {332, 3}, // 39: expression (OPEN_SQUARE_BRACKET) ->  OPEN_SQUARE_BRACKET arraypart CLOSING_SQUARE_BRACKET
     ...
     {332, 4}, // 44: expression (COMMAND_RETURNER) ->  COMMAND_RETURNER OPEN_CURLY_BRACKET command CLOSING_CURLY_BRACKET
     ...
     {337, 4}, // 59: case_part (CLOSING_PARENTHESIS) ->  expression CLOSING_PARENTHESIS command_list CASE_DELIMITER
...
{
    { { REQ_TOKEN}, {  3} },                    
    { {       281}, { 14} }, // OPEN_PARENTHESIS
    { {       302}, { 15} }, // OPERATOR_ASSIGN 
    { {         0}, {  0} },                    
};
...
{
    { { REQ_TOKEN}, {   3} },                          
    { {       296}, { 104} }, // CLOSING_SQUARE_BRACKET
...
{
    { { REQ_TOKEN}, {  16} },                           
    { {       296}, { 118} }, // CLOSING_SQUARE_BRACKET 
    { {       303}, {  53} }, // OPERATOR_AND           
    { {       304}, {  54} }, // OPERATOR_OR            
    { {       305}, {  55} }, // OPERATOR_EQUAL         
    { {       310}, {  56} }, // OPERATOR_NOT_EQUAL     
