// Generated by Bisonc++ V6.00.00 on Mon, 23 Jul 2018 16:58:00 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {330, 2}, // 1: start (KEYWORD_EXIT) ->  command_list KEYWORD_EXIT
     {331, 3}, // 2: command_list (COMMAND_SEPARATOR) ->  command_list command COMMAND_SEPARATOR
     {331, 3}, // 3: command_list (errTok__) ->  command_list errTok__ COMMAND_SEPARATOR
     {331, 2}, // 4: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR
     {331, 2}, // 5: command_list (errTok__) ->  errTok__ COMMAND_SEPARATOR
     {332, 4}, // 6: command (IDENTIFIER) ->  IDENTIFIER OPEN_PARENTHESIS arguments CLOSING_PARENTHESIS
     {332, 3}, // 7: command (IDENTIFIER) ->  IDENTIFIER OPERATOR_ASSIGN expression
     {332, 4}, // 8: command (KEYWORD_LOCAL) ->  KEYWORD_LOCAL IDENTIFIER OPERATOR_ASSIGN expression
     {332, 3}, // 9: command (OPEN_CURLY_BRACKET) ->  OPEN_CURLY_BRACKET command_list CLOSING_CURLY_BRACKET
     {332, 7}, // 10: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_IN expression_list KEYWORD_DO command_list KEYWORD_DONE
     {332, 9}, // 11: command (KEYWORD_FOR) ->  KEYWORD_FOR command COMMAND_SEPARATOR expression COMMAND_SEPARATOR command KEYWORD_DO command_list KEYWORD_DONE
     {332, 5}, // 12: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {332, 5}, // 13: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {332, 9}, // 14: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_DO caseparts KEYWORD_DEFAULT CLOSING_PARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {332, 6}, // 15: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {333, 3}, // 16: expression (OPEN_PARENTHESIS) ->  OPEN_PARENTHESIS expression CLOSING_PARENTHESIS
     {333, 2}, // 17: expression (NEGATE) ->  NEGATE expression
     {333, 3}, // 18: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {333, 3}, // 19: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {333, 3}, // 20: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {333, 3}, // 21: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {333, 3}, // 22: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {333, 3}, // 23: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {333, 3}, // 24: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {333, 3}, // 25: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {333, 3}, // 26: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {333, 3}, // 27: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {333, 3}, // 28: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {333, 3}, // 29: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {333, 3}, // 30: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {333, 3}, // 31: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {333, 2}, // 32: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {333, 4}, // 33: expression (IDENTIFIER) ->  IDENTIFIER OPEN_SQUARE_BRACKET expression CLOSING_SQUARE_BRACKET
     {333, 1}, // 34: expression (INTEGER) ->  INTEGER
     {333, 1}, // 35: expression (DOUBLE) ->  DOUBLE
     {333, 1}, // 36: expression (SINGLE_QUOTE) ->  SINGLE_QUOTE
     {333, 1}, // 37: expression (DOUBLE_QUOTE) ->  DOUBLE_QUOTE
     {333, 1}, // 38: expression (HEXADECIMAL) ->  HEXADECIMAL
     {333, 1}, // 39: expression ->  input_output
     {333, 1}, // 40: expression (IDENTIFIER) ->  IDENTIFIER
     {333, 3}, // 41: expression (OPEN_SQUARE_BRACKET) ->  OPEN_SQUARE_BRACKET arraypart CLOSING_SQUARE_BRACKET
     {333, 1}, // 42: expression (CONST_TRUE) ->  CONST_TRUE
     {333, 1}, // 43: expression (CONST_FALSE) ->  CONST_FALSE
     {333, 1}, // 44: expression (CONST_PI) ->  CONST_PI
     {333, 1}, // 45: expression (CONST_NULL) ->  CONST_NULL
     {333, 4}, // 46: expression (COMMAND_RETURNER) ->  COMMAND_RETURNER OPEN_CURLY_BRACKET command CLOSING_CURLY_BRACKET
     {334, 3}, // 47: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression
     {334, 5}, // 48: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression ARROW expression
     {334, 1}, // 49: arraypart ->  expression
     {334, 3}, // 50: arraypart (ARROW) ->  expression ARROW expression
     {334, 0}, // 51: arraypart ->  <empty>
     {335, 3}, // 52: arguments (ELEMENT_SEPARATOR) ->  arguments ELEMENT_SEPARATOR expression
     {335, 1}, // 53: arguments ->  expression
     {335, 0}, // 54: arguments ->  <empty>
     {336, 2}, // 55: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {336, 2}, // 56: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {336, 2}, // 57: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {336, 2}, // 58: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {337, 2}, // 59: caseparts ->  caseparts case_part
     {337, 1}, // 60: caseparts ->  case_part
     {338, 4}, // 61: case_part (CLOSING_PARENTHESIS) ->  expression CLOSING_PARENTHESIS command_list CASE_DELIMITER
     {339, 2}, // 62: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {339, 0}, // 63: else_part ->  <empty>
     {340, 3}, // 64: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {340, 1}, // 65: expression_list ->  expression
     {341, 1}, // 66: start_$ ->  start
};
...
SR__ s_9[] =
{
    ...
    { {       301}, { 38} }, // CONST_PI                  
    { {       302}, { 39} }, // CONST_NULL                
    { {       294}, { 40} }, // COMMAND_RETURNER          
    { {       285}, { 41} }, // OUTPUT_CREATION           
    { {       283}, { 42} }, // INPUT_REDIRECTION         
    { {       284}, { 43} }, // INPUT_FROM_A_HERE_DOCUMENT
    { {       286}, { 44} }, // OUTPUT_APPEND             
    { {         0}, {  0} },                              
};
...
SR__ s_24[] =
{
    ...
    { {       304}, { 58} }, // OPERATOR_AND           
    { {       305}, { 59} }, // OPERATOR_OR            
    { {       306}, { 60} }, // OPERATOR_EQUAL         
    { {       311}, { 61} }, // OPERATOR_NOT_EQUAL     
    { {       310}, { 62} }, // OPERATOR_LESS_EQUAL    
    { {       309}, { 63} }, // OPERATOR_GREATER_EQUAL 
    { {       308}, { 64} }, // OPERATOR_LESS_THAN     
    { {       307}, { 65} }, // OPERATOR_GREATER_THAN  
    { {       312}, { 66} }, // OPERATOR_PLUS          
    { {       313}, { 67} }, // OPERATOR_MINUS         
    { {       314}, { 68} }, // OPERATOR_MULTIPLICATION
    { {       315}, { 69} }, // OPERATOR_DIVISION      
    { {       316}, { 70} }, // OPERATOR_MODULO        
    { {       317}, { 71} }, // OPERATOR_POWER         
    { {         0}, {  0} },                           
};
...
{
    { { REQ_TOKEN}, {  3} },                       
    { {       282}, { 86} }, // CLOSING_PARENTHESIS
    { {       278}, { 87} }, // ELEMENT_SEPARATOR  
    { {         0}, {  0} },                       
};
...
{
    { { REQ_TOKEN}, {   3} },                          
    { {       296}, { 109} }, // CLOSING_SQUARE_BRACKET
...
{
    { { REQ_TOKEN}, {  16} },                           
    { {       296}, { 123} }, // CLOSING_SQUARE_BRACKET 
    { {       304}, {  58} }, // OPERATOR_AND           
    { {       305}, {  59} }, // OPERATOR_OR            
    { {       306}, {  60} }, // OPERATOR_EQUAL         
    { {       311}, {  61} }, // OPERATOR_NOT_EQUAL     
