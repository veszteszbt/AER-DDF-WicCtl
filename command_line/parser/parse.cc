// Generated by Bisonc++ V6.00.00 on Tue, 31 Jul 2018 10:02:35 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {328, 9}, // 11: command (KEYWORD_FOR) ->  KEYWORD_FOR command COMMAND_SEPARATOR expression COMMAND_SEPARATOR command KEYWORD_DO command_list KEYWORD_DONE
     {328, 5}, // 12: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {328, 5}, // 13: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {328, 9}, // 14: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_DO caseparts KEYWORD_DEFAULT CLOSING_PARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {328, 6}, // 15: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {329, 3}, // 16: expression (OPEN_PARENTHESIS) ->  OPEN_PARENTHESIS expression CLOSING_PARENTHESIS
     {329, 2}, // 17: expression (NEGATE) ->  NEGATE expression
     {329, 3}, // 18: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {329, 3}, // 19: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {329, 3}, // 20: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {329, 3}, // 21: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {329, 3}, // 22: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {329, 3}, // 23: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {329, 3}, // 24: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {329, 3}, // 25: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {329, 3}, // 26: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {329, 3}, // 27: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {329, 3}, // 28: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {329, 3}, // 29: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {329, 3}, // 30: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {329, 3}, // 31: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {329, 2}, // 32: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {329, 4}, // 33: expression (IDENTIFIER) ->  IDENTIFIER OPEN_SQUARE_BRACKET expression CLOSING_SQUARE_BRACKET
     {329, 1}, // 34: expression (INTEGER) ->  INTEGER
     {329, 1}, // 35: expression (DOUBLE) ->  DOUBLE
     {329, 1}, // 36: expression (SINGLE_QUOTE) ->  SINGLE_QUOTE
     {329, 1}, // 37: expression (DOUBLE_QUOTE) ->  DOUBLE_QUOTE
     {329, 1}, // 38: expression (HEXADECIMAL) ->  HEXADECIMAL
     {329, 1}, // 39: expression ->  input_output
     {329, 1}, // 40: expression (IDENTIFIER) ->  IDENTIFIER
     {329, 3}, // 41: expression (OPEN_SQUARE_BRACKET) ->  OPEN_SQUARE_BRACKET arraypart CLOSING_SQUARE_BRACKET
     {329, 1}, // 42: expression (CONST_NULL) ->  CONST_NULL
     {329, 4}, // 43: expression (COMMAND_RETURNER) ->  COMMAND_RETURNER OPEN_CURLY_BRACKET command CLOSING_CURLY_BRACKET
     {330, 3}, // 44: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression
     {330, 5}, // 45: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR expression ARROW expression
     {330, 1}, // 46: arraypart ->  expression
     {330, 3}, // 47: arraypart (ARROW) ->  expression ARROW expression
     {330, 0}, // 48: arraypart ->  <empty>
     {331, 3}, // 49: arguments (ELEMENT_SEPARATOR) ->  arguments ELEMENT_SEPARATOR expression
     {331, 1}, // 50: arguments ->  expression
     {331, 0}, // 51: arguments ->  <empty>
     {332, 2}, // 52: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {332, 2}, // 53: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {332, 2}, // 54: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {332, 2}, // 55: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {333, 2}, // 56: caseparts ->  caseparts case_part
     {333, 1}, // 57: caseparts ->  case_part
     {334, 4}, // 58: case_part (CLOSING_PARENTHESIS) ->  expression CLOSING_PARENTHESIS command_list CASE_DELIMITER
     {335, 2}, // 59: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {335, 0}, // 60: else_part ->  <empty>
     {336, 3}, // 61: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {336, 1}, // 62: expression_list ->  expression
     {337, 1}, // 63: start_$ ->  start
};
...
{
    { { REQ_TOKEN}, {   3} },                          
    { {       296}, { 106} }, // CLOSING_SQUARE_BRACKET
    { {       278}, { 107} }, // ELEMENT_SEPARATOR     
    { {         0}, {   0} },                          
};
...
{
    { { REQ_TOKEN}, {  16} },                           
    { {       296}, { 120} }, // CLOSING_SQUARE_BRACKET 
    { {       300}, {  55} }, // OPERATOR_AND           
    { {       301}, {  56} }, // OPERATOR_OR            
    { {       302}, {  57} }, // OPERATOR_EQUAL         
    { {       307}, {  58} }, // OPERATOR_NOT_EQUAL     
