...
PI__ const s_productionInfo[] = 
{
     ...
     {323, 2}, // 1: start ->  command_list end
     {323, 1}, // 2: start ->  end
     {324, 1}, // 3: end (EXIT_CALL) ->  EXIT_CALL
     {325, 3}, // 4: command_list (COMMAND_SEPARATOR) ->  command_list command COMMAND_SEPARATOR
     {325, 2}, // 5: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR
     {326, 1}, // 6: command ->  expression
     {326, 3}, // 7: command (OCURLY) ->  OCURLY command_list CCURLY
     {326, 5}, // 8: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_DO command_list KEYWORD_DONE
     {326, 7}, // 9: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_IN expression_list KEYWORD_DO command_list KEYWORD_DONE
     {326, 9}, // 10: command (KEYWORD_FOR) ->  KEYWORD_FOR expression COMMAND_SEPARATOR expression COMMAND_SEPARATOR expression KEYWORD_DO command_list KEYWORD_DONE
     {326, 5}, // 11: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {326, 5}, // 12: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {326, 9}, // 13: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_IN caseparts KEYWORD_DEFAULT CPARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {326, 6}, // 14: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {327, 3}, // 15: expression (OPARENTHESIS) ->  OPARENTHESIS expression CPARENTHESIS
     {327, 3}, // 16: expression (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE expression
     {327, 4}, // 17: expression (KEYWORD_LOCAL) ->  KEYWORD_LOCAL IDENTIFIER OPERATOR_LET_BE expression
     {327, 2}, // 18: expression (NEGATE) ->  NEGATE expression
     {327, 3}, // 19: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {327, 3}, // 20: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {327, 3}, // 21: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {327, 3}, // 22: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {327, 3}, // 23: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {327, 3}, // 24: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {327, 3}, // 25: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {327, 3}, // 26: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {327, 3}, // 27: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {327, 3}, // 28: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {327, 3}, // 29: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {327, 3}, // 30: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {327, 3}, // 31: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {327, 3}, // 32: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {327, 2}, // 33: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {327, 1}, // 34: expression (INTEGER) ->  INTEGER
     {327, 1}, // 35: expression (DOUBLE) ->  DOUBLE
     {327, 1}, // 36: expression (SINGLEQUOTE) ->  SINGLEQUOTE
     {327, 1}, // 37: expression (DOUBLEQUOTE) ->  DOUBLEQUOTE
     {327, 1}, // 38: expression (HEXADECIMAL) ->  HEXADECIMAL
     {327, 1}, // 39: expression ->  input_output
     {327, 1}, // 40: expression (IDENTIFIER) ->  IDENTIFIER
     {327, 1}, // 41: expression (CONST_TRUE) ->  CONST_TRUE
     {327, 1}, // 42: expression (CONST_FALSE) ->  CONST_FALSE
     {327, 1}, // 43: expression (CONST_PI) ->  CONST_PI
     {328, 2}, // 44: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {328, 2}, // 45: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {328, 2}, // 46: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {328, 2}, // 47: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {329, 2}, // 48: caseparts ->  caseparts case_part
     {329, 1}, // 49: caseparts ->  case_part
     {330, 4}, // 50: case_part (CPARENTHESIS) ->  expression CPARENTHESIS command_list CASE_DELIMITER
     {331, 2}, // 51: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {331, 0}, // 52: else_part ->  <empty>
     {332, 3}, // 53: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {332, 1}, // 54: expression_list ->  expression
     {333, 1}, // 55: start_$ ->  start
};
...
SR__ s_0[] =
{
    ...
    { {       281}, { 13} }, // OPARENTHESIS              
    { {       291}, { 14} }, // IDENTIFIER                
    { {       271}, { 15} }, // KEYWORD_LOCAL             
    { {       292}, { 16} }, // NEGATE                    
    { {       308}, { 17} }, // OPERATOR_MINUS            
    { {       290}, { 18} }, // INTEGER                   
    { {       289}, { 19} }, // DOUBLE                    
    { {       287}, { 20} }, // SINGLEQUOTE               
    { {       288}, { 21} }, // DOUBLEQUOTE               
    ...
    { {       295}, { 25} }, // CONST_FALSE               
    { {       296}, { 26} }, // CONST_PI                  
    { {       285}, { 27} }, // OUTPUT_CREATION           
    { {       283}, { 28} }, // INPUT_REDIRECTION         
    { {       284}, { 29} }, // INPUT_FROM_A_HERE_DOCUMENT
    { {       286}, { 30} }, // OUTPUT_APPEND             
    { {         0}, {  0} },                              
};
...
SR__ s_6[] =
{
    ...
    { {     299}, { 34} }, // OPERATOR_AND           
    { {     300}, { 35} }, // OPERATOR_OR            
    { {     301}, { 36} }, // OPERATOR_EQUAL         
    { {     306}, { 37} }, // OPERATOR_NOT_EQUAL     
    { {     305}, { 38} }, // OPERATOR_LESS_EQUAL    
    { {     304}, { 39} }, // OPERATOR_GREATER_EQUAL 
    { {     303}, { 40} }, // OPERATOR_LESS_THAN     
    { {     302}, { 41} }, // OPERATOR_GREATER_THAN  
    { {     307}, { 42} }, // OPERATOR_PLUS          
    { {     308}, { 43} }, // OPERATOR_MINUS         
    { {     309}, { 44} }, // OPERATOR_MULTIPLICATION
    { {     310}, { 45} }, // OPERATOR_DIVISION      
    { {     311}, { 46} }, // OPERATOR_MODULO        
    { {     312}, { 47} }, // OPERATOR_POWER         
    { {       0}, { -6} },                           
};
...
#line 206 "grammar"
        {
         d_val__.exd = new expr_local_asg(d_loc__.first_line, vs__(-2).str, vs__(0).exd);
