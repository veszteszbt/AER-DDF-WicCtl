// Generated by Bisonc++ V6.00.00 on Sat, 07 Apr 2018 16:04:04 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {316, 3}, // 2: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR command_list
     {316, 0}, // 3: command_list ->  <empty>
     {317, 1}, // 4: command ->  expression
     {317, 1}, // 5: command ->  assign
     {317, 3}, // 6: command (OPARENTHESIS) ->  OPARENTHESIS command_list CPARENTHESIS
     {317, 3}, // 7: command (OCURLY) ->  OCURLY command_list CCURLY
     {317, 5}, // 8: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_DO command_list KEYWORD_DONE
     {317, 7}, // 9: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_IN expression KEYWORD_DO command_list KEYWORD_DONE
     {317, 11}, // 10: command (KEYWORD_FOR) ->  KEYWORD_FOR OPARENTHESIS assign COMMAND_SEPARATOR expression COMMAND_SEPARATOR expression CPARENTHESIS KEYWORD_DO command_list KEYWORD_DONE
     {317, 5}, // 11: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {317, 5}, // 12: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {317, 5}, // 13: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_IN caseparts KEYWORD_ESAC
     {317, 6}, // 14: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     ...
     {319, 1}, // 35: expression ->  input_output
     {319, 1}, // 36: expression (IDENTIFIER) ->  IDENTIFIER
     {319, 1}, // 37: expression (CONST_TRUE) ->  CONST_TRUE
     {319, 1}, // 38: expression (CONST_FALSE) ->  CONST_FALSE
     {319, 1}, // 39: expression (CONST_PI) ->  CONST_PI
     {320, 2}, // 40: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {320, 2}, // 41: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {320, 2}, // 42: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {320, 2}, // 43: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {321, 3}, // 44: assign (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE expression
     {318, 2}, // 45: caseparts ->  case_part caseparts2
     {323, 2}, // 46: caseparts2 ->  case_part caseparts2
     {323, 0}, // 47: caseparts2 ->  <empty>
     {322, 4}, // 48: case_part (CPARENTHESIS) ->  pattern CPARENTHESIS command_list CASE_DELIMITER
     {325, 2}, // 49: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {325, 0}, // 50: else_part ->  <empty>
     {324, 1}, // 51: pattern (IDENTIFIER) ->  IDENTIFIER
     {324, 3}, // 52: pattern (PIPE_SYMBOL) ->  pattern PIPE_SYMBOL IDENTIFIER
     {326, 1}, // 53: start_$ ->  start
};
...
#line 97 "grammar"
        {
         d_val__.cld = new command_list_desc();
         command_desc* tempcd = new command_desc(vs__(0).exd->get_row());
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 136 "grammar"
        {
         command_desc* tempcd = new for_in_desc(vs__(-5).exd, vs__(-3).exd, vs__(-1).cld);
         d_val__.cld = new command_list_desc();
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 145 "grammar"
        {
         command_desc* tempcd = new for_3_desc(vs__(-8).ad, vs__(-6).exd, vs__(-4).exd, vs__(-1).cld);
         d_val__.cld = new command_list_desc();
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 154 "grammar"
        {
         command_desc* tempcd = new while_desc(vs__(-3).exd, vs__(-1).cld);
         d_val__.cld = new command_list_desc();
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 163 "grammar"
        {
         command_desc* tempcd = new until_desc(vs__(-3).exd, vs__(-1).cld);
         d_val__.cld = new command_list_desc();
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 177 "grammar"
        {
         command_desc* tempcd = new if_desc(vs__(-4).exd, vs__(-2).cld, vs__(-1).cld);
         d_val__.cld = new command_list_desc();
         d_val__.cld->add(tempcd);
         delete tempcd;
...
#line 279 "grammar"
        {
         d_val__.exd = new expr_neg(d_loc__.first_line,vs__(0).exd);
         std::cout << "OPERATOR_MINUS expression %prec UNARY_MINUS" << std::endl;
         }
        break;
...
#line 285 "grammar"
        {
         ...
         d_val__.exd = new expression_desc(d_loc__.first_line, u_integer);
...
#line 318 "grammar"
        {
         if( symbol_table.count( *vs__(0).str) == 0)
         {
         std::cerr << d_loc__.first_line << ": " << *vs__(0).str << "variable wasn't declared before." << std::endl;
         }
         else
         {
         variable_desc vd = symbol_table[*vs__(0).str];
         d_val__.exd = new expression_desc(vd.decl_row, vd.var_type);
         }
...
#line 384 "grammar"
        {
         ...
         d_val__.ad = new assign_desc(vs__(-2).str, vs__(0).exd);
         }
        break;
