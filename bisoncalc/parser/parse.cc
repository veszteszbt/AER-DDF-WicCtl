// Generated by Bisonc++ V6.00.00 on Sat, 16 Jun 2018 16:50:12 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {322, 2}, // 1: start ->  command_list end
     {322, 1}, // 2: start ->  end
     {323, 1}, // 3: end (EXIT_CALL) ->  EXIT_CALL
     {324, 3}, // 4: command_list (COMMAND_SEPARATOR) ->  command_list command COMMAND_SEPARATOR
     {324, 2}, // 5: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR
     {325, 1}, // 6: command ->  expression
     {325, 3}, // 7: command (OCURLY) ->  OCURLY command_list CCURLY
     {325, 5}, // 8: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_DO command_list KEYWORD_DONE
     {325, 7}, // 9: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_IN expression_list KEYWORD_DO command_list KEYWORD_DONE
     {325, 9}, // 10: command (KEYWORD_FOR) ->  KEYWORD_FOR expression COMMAND_SEPARATOR expression COMMAND_SEPARATOR expression KEYWORD_DO command_list KEYWORD_DONE
     {325, 5}, // 11: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {325, 5}, // 12: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {325, 9}, // 13: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_IN caseparts KEYWORD_DEFAULT CPARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {325, 6}, // 14: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {326, 3}, // 15: expression (OPARENTHESIS) ->  OPARENTHESIS expression CPARENTHESIS
     {326, 3}, // 16: expression (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE expression
     {326, 2}, // 17: expression (NEGATE) ->  NEGATE expression
     {326, 3}, // 18: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {326, 3}, // 19: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {326, 3}, // 20: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {326, 3}, // 21: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {326, 3}, // 22: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {326, 3}, // 23: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {326, 3}, // 24: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {326, 3}, // 25: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {326, 3}, // 26: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {326, 3}, // 27: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {326, 3}, // 28: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {326, 3}, // 29: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {326, 3}, // 30: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {326, 3}, // 31: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {326, 2}, // 32: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {326, 1}, // 33: expression (INTEGER) ->  INTEGER
     {326, 1}, // 34: expression (DOUBLE) ->  DOUBLE
     {326, 1}, // 35: expression (SINGLEQUOTE) ->  SINGLEQUOTE
     {326, 1}, // 36: expression (DOUBLEQUOTE) ->  DOUBLEQUOTE
     {326, 1}, // 37: expression (HEXADECIMAL) ->  HEXADECIMAL
     {326, 1}, // 38: expression ->  input_output
     {326, 1}, // 39: expression (IDENTIFIER) ->  IDENTIFIER
     {326, 1}, // 40: expression (CONST_TRUE) ->  CONST_TRUE
     {326, 1}, // 41: expression (CONST_FALSE) ->  CONST_FALSE
     {326, 1}, // 42: expression (CONST_PI) ->  CONST_PI
     {327, 2}, // 43: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {327, 2}, // 44: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {327, 2}, // 45: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {327, 2}, // 46: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {328, 2}, // 47: caseparts ->  caseparts case_part
     {328, 1}, // 48: caseparts ->  case_part
     {329, 4}, // 49: case_part (CPARENTHESIS) ->  expression CPARENTHESIS command_list CASE_DELIMITER
     {330, 2}, // 50: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {330, 0}, // 51: else_part ->  <empty>
     {331, 3}, // 52: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {331, 1}, // 53: expression_list ->  expression
     {332, 1}, // 54: start_$ ->  start
};
...
SR__ s_0[] =
{
    ...
    { {       294}, { 24} }, // CONST_FALSE               
    { {       295}, { 25} }, // CONST_PI                  
    { {       284}, { 26} }, // OUTPUT_CREATION           
    { {       282}, { 27} }, // INPUT_REDIRECTION         
    { {       283}, { 28} }, // INPUT_FROM_A_HERE_DOCUMENT
    { {       285}, { 29} }, // OUTPUT_APPEND             
    { {         0}, {  0} },                              
};
...
SR__ s_6[] =
{
    ...
    { {     298}, { 33} }, // OPERATOR_AND           
    { {     299}, { 34} }, // OPERATOR_OR            
    { {     300}, { 35} }, // OPERATOR_EQUAL         
    { {     305}, { 36} }, // OPERATOR_NOT_EQUAL     
    { {     304}, { 37} }, // OPERATOR_LESS_EQUAL    
    { {     303}, { 38} }, // OPERATOR_GREATER_EQUAL 
    { {     302}, { 39} }, // OPERATOR_LESS_THAN     
    { {     301}, { 40} }, // OPERATOR_GREATER_THAN  
    { {     306}, { 41} }, // OPERATOR_PLUS          
    { {     307}, { 42} }, // OPERATOR_MINUS         
    { {     308}, { 43} }, // OPERATOR_MULTIPLICATION
    { {     309}, { 44} }, // OPERATOR_DIVISION      
    { {     310}, { 45} }, // OPERATOR_MODULO        
    { {     311}, { 46} }, // OPERATOR_POWER         
    { {       0}, { -6} },                           
};
...
#line 135 "grammar"
        {
         ...
         d_val__.cd = new command_expr(vs__(-1).cld);
