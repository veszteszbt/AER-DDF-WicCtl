// Generated by Bisonc++ V6.00.00 on Wed, 11 Jul 2018 13:16:00 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {333, 5}, // 46: arraypart (ELEMENT_SEPARATOR) ->  arraypart ELEMENT_SEPARATOR DOUBLEQUOTE ARROW expression
     {333, 1}, // 47: arraypart ->  expression
     {333, 3}, // 48: arraypart (DOUBLEQUOTE) ->  DOUBLEQUOTE ARROW expression
...
#line 397 "grammar"
        {
         ...
         std::string* temp = new std::string((*vs__(-2).str).substr(1,(*vs__(-2).str).size()-2));
         d_val__.ar->add(*temp, vs__(0).exd);
         delete temp;
...
#line 415 "grammar"
        {
         ...
         d_val__.ar->add(*temp, vs__(0).exd);
         delete temp;
         journal(journal::info, "parser") << "arraypart -> DOUBLEQUOTE ARROW expression" << journal::end;
         }
        break;
