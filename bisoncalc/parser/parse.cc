// Generated by Bisonc++ V6.00.00 on Tue, 03 Jul 2018 13:41:02 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {325, 2}, // 1: start ->  command_list end
     {325, 1}, // 2: start ->  end
     {326, 1}, // 3: end (EXIT_CALL) ->  EXIT_CALL
     {327, 3}, // 4: command_list (COMMAND_SEPARATOR) ->  command_list command COMMAND_SEPARATOR
     {327, 2}, // 5: command_list (COMMAND_SEPARATOR) ->  command COMMAND_SEPARATOR
     {328, 4}, // 6: command (IDENTIFIER) ->  IDENTIFIER OPARENTHESIS arguments CPARENTHESIS
     {328, 3}, // 7: command (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE expression
     {328, 4}, // 8: command (KEYWORD_LOCAL) ->  KEYWORD_LOCAL IDENTIFIER OPERATOR_LET_BE expression
     {328, 3}, // 9: command (OCURLY) ->  OCURLY command_list CCURLY
     ...
     {328, 9}, // 14: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_IN caseparts KEYWORD_DEFAULT CPARENTHESIS command_list CASE_DELIMITER KEYWORD_ESAC
     {328, 6}, // 15: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {329, 3}, // 16: expression (OPARENTHESIS) ->  OPARENTHESIS expression CPARENTHESIS
     ...
     {329, 1}, // 33: expression (INTEGER) ->  INTEGER
     {329, 1}, // 34: expression (DOUBLE) ->  DOUBLE
     {329, 1}, // 35: expression (SINGLEQUOTE) ->  SINGLEQUOTE
     {329, 1}, // 36: expression (DOUBLEQUOTE) ->  DOUBLEQUOTE
     {329, 1}, // 37: expression (HEXADECIMAL) ->  HEXADECIMAL
     {329, 1}, // 38: expression ->  input_output
     {329, 1}, // 39: expression (IDENTIFIER) ->  IDENTIFIER
     {329, 1}, // 40: expression (CONST_TRUE) ->  CONST_TRUE
     {329, 1}, // 41: expression (CONST_FALSE) ->  CONST_FALSE
     {329, 1}, // 42: expression (CONST_PI) ->  CONST_PI
     {329, 4}, // 43: expression (COMMAND_RETURNER) ->  COMMAND_RETURNER OCURLY command CCURLY
     {330, 3}, // 44: arguments (ELEMENT_SEPARATOR) ->  arguments ELEMENT_SEPARATOR expression
     {330, 1}, // 45: arguments ->  expression
     {330, 0}, // 46: arguments ->  <empty>
     {331, 2}, // 47: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {331, 2}, // 48: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {331, 2}, // 49: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {331, 2}, // 50: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {332, 2}, // 51: caseparts ->  caseparts case_part
     {332, 1}, // 52: caseparts ->  case_part
     {333, 4}, // 53: case_part (CPARENTHESIS) ->  expression CPARENTHESIS command_list CASE_DELIMITER
     {334, 2}, // 54: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {334, 0}, // 55: else_part ->  <empty>
     {335, 3}, // 56: expression_list (ELEMENT_SEPARATOR) ->  expression_list ELEMENT_SEPARATOR expression
     {335, 1}, // 57: expression_list ->  expression
     {336, 1}, // 58: start_$ ->  start
};
...
SR__ s_23[] =
{
    ...
    { {       300}, { 54} }, // OPERATOR_AND           
    { {       301}, { 55} }, // OPERATOR_OR            
    { {       302}, { 56} }, // OPERATOR_EQUAL         
    { {       307}, { 57} }, // OPERATOR_NOT_EQUAL     
    { {       306}, { 58} }, // OPERATOR_LESS_EQUAL    
    { {       305}, { 59} }, // OPERATOR_GREATER_EQUAL 
    { {       304}, { 60} }, // OPERATOR_LESS_THAN     
    { {       303}, { 61} }, // OPERATOR_GREATER_THAN  
    { {       308}, { 62} }, // OPERATOR_PLUS          
    { {       309}, { 63} }, // OPERATOR_MINUS         
    { {       310}, { 64} }, // OPERATOR_MULTIPLICATION
    { {       311}, { 65} }, // OPERATOR_DIVISION      
    { {       312}, { 66} }, // OPERATOR_MODULO        
    { {       313}, { 67} }, // OPERATOR_POWER         
    { {         0}, {  0} },                           
};
