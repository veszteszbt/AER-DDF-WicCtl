// Generated by Bisonc++ V6.00.00 on Sat, 12 May 2018 14:17:47 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {317, 1}, // 1: start ->  command_list
     {318, 3}, // 2: command_list (COMMAND_SEPARATOR) ->  command_list COMMAND_SEPARATOR command
     {318, 1}, // 3: command_list ->  command
     {319, 1}, // 4: command ->  expression
     {319, 3}, // 5: command (OCURLY) ->  OCURLY command_list CCURLY
     {319, 5}, // 6: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_DO command_list KEYWORD_DONE
     {319, 7}, // 7: command (KEYWORD_FOR) ->  KEYWORD_FOR expression KEYWORD_IN expression KEYWORD_DO command_list KEYWORD_DONE
     {319, 9}, // 8: command (KEYWORD_FOR) ->  KEYWORD_FOR expression COMMAND_SEPARATOR expression COMMAND_SEPARATOR expression KEYWORD_DO command_list KEYWORD_DONE
     {319, 5}, // 9: command (KEYWORD_WHILE) ->  KEYWORD_WHILE expression KEYWORD_DO command_list KEYWORD_DONE
     {319, 5}, // 10: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL expression KEYWORD_DO command_list KEYWORD_DONE
     {319, 5}, // 11: command (KEYWORD_CASE) ->  KEYWORD_CASE expression KEYWORD_IN caseparts KEYWORD_ESAC
     {319, 6}, // 12: command (KEYWORD_IF) ->  KEYWORD_IF expression KEYWORD_THEN command_list else_part KEYWORD_FI
     {319, 1}, // 13: command (EXIT_CALL) ->  EXIT_CALL
     {321, 3}, // 14: expression (OPARENTHESIS) ->  OPARENTHESIS expression CPARENTHESIS
     {321, 3}, // 15: expression (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE expression
     {321, 2}, // 16: expression (NEGATE) ->  NEGATE expression
     {321, 3}, // 17: expression (OPERATOR_AND) ->  expression OPERATOR_AND expression
     {321, 3}, // 18: expression (OPERATOR_OR) ->  expression OPERATOR_OR expression
     {321, 3}, // 19: expression (OPERATOR_EQUAL) ->  expression OPERATOR_EQUAL expression
     {321, 3}, // 20: expression (OPERATOR_NOT_EQUAL) ->  expression OPERATOR_NOT_EQUAL expression
     {321, 3}, // 21: expression (OPERATOR_LESS_EQUAL) ->  expression OPERATOR_LESS_EQUAL expression
     {321, 3}, // 22: expression (OPERATOR_GREATER_EQUAL) ->  expression OPERATOR_GREATER_EQUAL expression
     {321, 3}, // 23: expression (OPERATOR_LESS_THAN) ->  expression OPERATOR_LESS_THAN expression
     {321, 3}, // 24: expression (OPERATOR_GREATER_THAN) ->  expression OPERATOR_GREATER_THAN expression
     {321, 3}, // 25: expression (OPERATOR_PLUS) ->  expression OPERATOR_PLUS expression
     {321, 3}, // 26: expression (OPERATOR_MINUS) ->  expression OPERATOR_MINUS expression
     {321, 3}, // 27: expression (OPERATOR_MULTIPLICATION) ->  expression OPERATOR_MULTIPLICATION expression
     {321, 3}, // 28: expression (OPERATOR_DIVISION) ->  expression OPERATOR_DIVISION expression
     {321, 3}, // 29: expression (OPERATOR_MODULO) ->  expression OPERATOR_MODULO expression
     {321, 3}, // 30: expression (OPERATOR_POWER) ->  expression OPERATOR_POWER expression
     {321, 2}, // 31: expression (UNARY_MINUS) ->  OPERATOR_MINUS expression
     {321, 1}, // 32: expression (INTEGER) ->  INTEGER
     {321, 1}, // 33: expression (DOUBLE) ->  DOUBLE
     {321, 1}, // 34: expression (SINGLEQUOTE) ->  SINGLEQUOTE
     {321, 1}, // 35: expression (DOUBLEQUOTE) ->  DOUBLEQUOTE
     {321, 1}, // 36: expression (HEXADECIMAL) ->  HEXADECIMAL
     {321, 1}, // 37: expression ->  input_output
     {321, 1}, // 38: expression (IDENTIFIER) ->  IDENTIFIER
     {321, 1}, // 39: expression (CONST_TRUE) ->  CONST_TRUE
     {321, 1}, // 40: expression (CONST_FALSE) ->  CONST_FALSE
     {321, 1}, // 41: expression (CONST_PI) ->  CONST_PI
     {322, 2}, // 42: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION IDENTIFIER
     {322, 2}, // 43: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION IDENTIFIER
     {322, 2}, // 44: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     {322, 2}, // 45: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {320, 2}, // 46: caseparts ->  case_part caseparts2
     {324, 2}, // 47: caseparts2 ->  case_part caseparts2
     {324, 0}, // 48: caseparts2 ->  <empty>
     {323, 4}, // 49: case_part (CPARENTHESIS) ->  pattern CPARENTHESIS command_list CASE_DELIMITER
     {326, 2}, // 50: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {326, 0}, // 51: else_part ->  <empty>
     {325, 1}, // 52: pattern (IDENTIFIER) ->  IDENTIFIER
     {325, 3}, // 53: pattern (PIPE_SYMBOL) ->  pattern PIPE_SYMBOL IDENTIFIER
     {327, 1}, // 54: start_$ ->  start
};
...
#line 144 "grammar"
        {
         ...
         d_val__.cd = new for_3_desc(vs__(-7).exd, vs__(-5).exd, vs__(-3).exd, vs__(-1).cld);
