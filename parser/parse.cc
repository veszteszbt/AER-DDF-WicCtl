// Generated by Bisonc++ V6.00.00 on Sat, 14 Apr 2018 12:46:50 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {298, 1}, // 2: command_list ->  andor
     {298, 2}, // 3: command_list (COMMAND_SEPARATOR) ->  command_list COMMAND_SEPARATOR
     {298, 2}, // 4: command_list (BACKGROUND_COMMANDS) ->  command_list BACKGROUND_COMMANDS
     {298, 3}, // 5: command_list (COMMAND_SEPARATOR) ->  command_list COMMAND_SEPARATOR andor
     {298, 3}, // 6: command_list (BACKGROUND_COMMANDS) ->  command_list BACKGROUND_COMMANDS andor
     {299, 1}, // 7: andor ->  pipeline
     {299, 3}, // 8: andor (ANDF_SYMBOL) ->  andor ANDF_SYMBOL pipeline
     {299, 3}, // 9: andor (ORF_SYMBOL) ->  andor ORF_SYMBOL pipeline
     {300, 1}, // 10: pipeline ->  command
     {300, 3}, // 11: pipeline (PIPE_SYMBOL) ->  pipeline PIPE_SYMBOL command
     {302, 1}, // 12: item (IDENTIFIER) ->  IDENTIFIER
     {302, 1}, // 13: item ->  input_output
     {302, 3}, // 14: item (IDENTIFIER) ->  IDENTIFIER OPERATOR_LET_BE value
     {304, 3}, // 15: value (OPERATOR_PLUS) ->  value OPERATOR_PLUS value
     {304, 3}, // 16: value (OPERATOR_MINUS) ->  value OPERATOR_MINUS value
     {304, 3}, // 17: value (OPERATOR_MULTIPLICATION) ->  value OPERATOR_MULTIPLICATION value
     {304, 3}, // 18: value (OPERATOR_DIVISION) ->  value OPERATOR_DIVISION value
     {304, 3}, // 19: value (OPERATOR_POWER) ->  value OPERATOR_POWER value
     {304, 3}, // 20: value (OPERATOR_MODULO) ->  value OPERATOR_MODULO value
     {304, 3}, // 21: value (OPERATOR_EQUALS) ->  value OPERATOR_EQUALS value
     {304, 3}, // 22: value (OPARENTHESIS) ->  OPARENTHESIS value CPARENTHESIS
     {304, 1}, // 23: value (FLOAT) ->  FLOAT
     {304, 1}, // 24: value (INTEGER) ->  INTEGER
     {304, 1}, // 25: value (SINGLEQUOTE) ->  SINGLEQUOTE
     {304, 1}, // 26: value (DOUBLEQUOTE) ->  DOUBLEQUOTE
     {304, 1}, // 27: value (IDENTIFIER) ->  IDENTIFIER
     {305, 1}, // 28: simple_command ->  item
     {305, 2}, // 29: simple_command ->  simple_command item
     {301, 1}, // 30: command ->  simple_command
     {301, 3}, // 31: command (OPARENTHESIS) ->  OPARENTHESIS command_list CPARENTHESIS
     {301, 3}, // 32: command (OCURLY) ->  OCURLY command_list CCURLY
     {301, 5}, // 33: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_DO command_list KEYWORD_DONE
     {301, 7}, // 34: command (KEYWORD_FOR) ->  KEYWORD_FOR IDENTIFIER KEYWORD_IF wordholderfirst KEYWORD_DO command_list KEYWORD_DONE
     {301, 5}, // 35: command (KEYWORD_WHILE) ->  KEYWORD_WHILE command_list KEYWORD_DO command_list KEYWORD_DONE
     {301, 5}, // 36: command (KEYWORD_UNTIL) ->  KEYWORD_UNTIL command_list KEYWORD_DO command_list KEYWORD_DONE
     {301, 5}, // 37: command (KEYWORD_CASE) ->  KEYWORD_CASE IDENTIFIER KEYWORD_IN case_partholderfirst KEYWORD_ESAC
     {301, 6}, // 38: command (KEYWORD_IF) ->  KEYWORD_IF command_list KEYWORD_THEN command_list else_part KEYWORD_FI
     {306, 2}, // 39: wordholderfirst (IDENTIFIER) ->  wordholder IDENTIFIER
     {309, 2}, // 40: wordholder (IDENTIFIER) ->  wordholder IDENTIFIER
     {309, 0}, // 41: wordholder ->  <empty>
     {307, 2}, // 42: case_partholderfirst ->  case_partholder case_part
     {310, 2}, // 43: case_partholder ->  case_partholder case_part
     {310, 0}, // 44: case_partholder ->  <empty>
     {303, 2}, // 45: input_output (OUTPUT_CREATION) ->  OUTPUT_CREATION file
     {303, 2}, // 46: input_output (INPUT_REDIRECTION) ->  INPUT_REDIRECTION file
     {303, 2}, // 47: input_output (OUTPUT_APPEND) ->  OUTPUT_APPEND IDENTIFIER
     {303, 2}, // 48: input_output (INPUT_FROM_A_HERE_DOCUMENT) ->  INPUT_FROM_A_HERE_DOCUMENT IDENTIFIER
     ...
     {311, 4}, // 52: case_part (CCURLY) ->  pattern CCURLY command_list CASE_DELIMITER
     {313, 1}, // 53: pattern (IDENTIFIER) ->  IDENTIFIER
     {313, 3}, // 54: pattern (PIPE_SYMBOL) ->  pattern PIPE_SYMBOL IDENTIFIER
     {308, 5}, // 55: else_part (KEYWORD_ELIF) ->  KEYWORD_ELIF command_list KEYWORD_THEN command_list else_part
     {308, 2}, // 56: else_part (KEYWORD_ELSE) ->  KEYWORD_ELSE command_list
     {308, 0}, // 57: else_part ->  <empty>
...
{
    { { DEF_RED}, {   3} },                        
    { {     307}, {  68} }, // case_partholderfirst
    { {     310}, {  69} }, // case_partholder     
    { {       0}, { -44} },                        
};
